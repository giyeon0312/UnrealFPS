...
AZombieCop::AZombieCop()
{
	...
	static ConstructorHelpers::FObjectFinder<USkeletalMesh>MeshAsset(TEXT("SkeletalMesh'/Game/Monster/ZombieCop/ZombieCop_Idle.ZombieCop_Idle'"));
	...
	static ConstructorHelpers::FClassFinder<UAnimInstance>	AnimAsset(TEXT("AnimBlueprint'/Game/Monster/BPZombieCopAnim.BPZombieCopAnim_C'"));

	if (AnimAsset.Succeeded())
		GetMesh()->SetAnimInstanceClass(AnimAsset.Class);

	m_Info.Name = TEXT("ZombieCop");
}

void AZombieCop::BeginPlay()
{
	Super::BeginPlay();

}

void AZombieCop::Tick(float DeltaTime)
{
