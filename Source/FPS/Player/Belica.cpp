...
ABelica::ABelica()
{
	...
	// 기본 애니메이션
	static ConstructorHelpers::FClassFinder<UAnimInstance> AnimAsset(TEXT("AnimBlueprint'/Game/Player/BPBelicaAnim.BPBelicaAnim_C'"));
	...
	// 궁수로 지정
	//m_Info.Name = TEXT("Archer");
	m_Info.Job = EPlayerJob::Archer;
}
